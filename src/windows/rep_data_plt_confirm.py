...
class RepDataPlotConfirmWindow:
    def __init__(self, root, proceed_callback_back, proceed_callback_next, material, input_status):
        self.root = root
        ...
        self.root.title("Repository Data Visualisation and Confirmation")

        # Restore previous geometry if avaiable
